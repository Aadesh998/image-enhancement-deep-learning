...
class ZeroDCE(nn.Module):
    ...
    def compute_losses(self, x, r, enhanced):
        ...
        loss_spatial = self.weights.spatial_constancy * self.spatial_loss_fn(enhanced, x)
        loss_color = self.weights.color_constancy * color_constancy_loss(enhanced)
        loss_exposure = self.weights.exposure * exposure_loss(enhanced, self.weights.exposure_mean_val)
